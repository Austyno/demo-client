...
const RequestForm = () => {
    ...
    return (
        <div style={{ maxWidth: '900px', margin: '2rem auto', padding: '2rem', backgroundColor: 'white', borderRadius: '8px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)', fontSize: '14px', fontFamily: 'Arial, sans-serif' }}>
